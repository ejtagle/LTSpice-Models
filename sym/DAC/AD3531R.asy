...
SYMATTR Value AD3531R
SYMATTR SpiceLine Gain=2
SYMATTR Prefix X
SYMATTR Description 8-channel, 16-bit Voltage Output DAC, On-chip Reference, SPI (one channel, output stage modeled)
SYMATTR ModelFile AD3531R.sub
PIN -160 0 LEFT 8
